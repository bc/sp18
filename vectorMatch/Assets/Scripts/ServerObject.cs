...
public class NetMqPublisher
{
    ...
    private const long ContactThreshold = 10;
...
public class ServerObject : MonoBehaviour
{
    ...
    private void Start()
    {
        matrixScript = MMult.GetComponent<MatrixMultiplication>();
    ...
    private void Update()
    {
        double[,] cCoords = matrixScript.getControllerLocation();
        _response = "" + cCoords[0,0] + "," + cCoords[0,1] + "," + cCoords[0,2] + "," + cCoords[0,3] + "," + cCoords[0,4] + "," + cCoords[0,5];
